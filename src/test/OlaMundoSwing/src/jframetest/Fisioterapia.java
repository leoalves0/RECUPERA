...
public class Fisioterapia extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Selecione a opção que deseja realizar");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        StringDoComboBox = String.valueOf(jComboBox1.getSelectedItem());
        switch (StringDoComboBox){
            case "Médico":{
            Medico TelaMedico = new Medico();
